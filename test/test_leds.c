...
/**
 * Descrip. del test: con todos los leds apagados prender el led 3 y verificar que efectivamente el bit 2 
 * se pone en 1 y el resto de bit permanece en 0.
 */
void test_prender_un_led(void)
{
    leds_turn_on(LED);
    TEST_ASSERT_BIT_HIGH(LED-1, leds_virtuales); // Verifica que el LED 3 (pos. 2 en el arreglo de bits) este en alto
    TEST_ASSERT_EQUAL_UINT16(0b0000000000000100, leds_virtuales); // Verifica que solo el LED 3 este prendido
}

/**
 * Descrip. del test: apagar un led prendido y ver que efectivamente se apaga y que el resto no cambia.
 */
